...
const Project = () => {
  ...
  return (
    <SafeAreaView className="flex-1 justify-start bg-background-color-1 px-6 py-8 space-y-4 ">
        ...
        <View className=''>
            <Text className='text-2xl font-medium'>Prokemia</Text>
        </View>
        <View className='space-y-2'>
            ...
            <View className='justify-between flex-row items-center'>
                ...
                <View className='flex-row items-end space-x-2'>
                    ...
                    <Text className='font-medium text-md'>80%</Text>
                </View>
            </View>
        </View>
        <View className='flex-row space-x-6 items-center'>
            <View className='flex-row space-x-2 items-center'>
                <Foundation name="flag" size={24} color="#565659" />
                <Text className='text-md font-medium text-[#565659]'>05-07-2023</Text>
            </View>
        </View>
        <View className='flex-row space-x-4'>
            <Text 
                className='text-md font-medium text-[#565659]' 
                style={{
                    borderBottomColor:(active_section == 0?'#714DD9':'#eee'),
                    borderBottomWidth:(active_section == 0? 2 : 0),
                    color:(active_section == 0? '#714DD9' : '#565659')
                }}
            >
                Overview
            </Text>
            <Text 
                className='text-md font-medium text-[#565659]' 
                style={{
                    borderBottomColor:(active_section == 1?'#714DD9':'#eee'),
                    borderBottomWidth:(active_section == 1? 2 : 0),
                    color:(active_section == 1? '#714DD9' : '#565659')
                }}
            >
            Attachments
            </Text>
            <Text 
                className='text-md font-medium text-[#565659]' 
                style={{
                    borderBottomColor:(active_section == 2?'#714DD9':'#eee'),
                    borderBottomWidth:(active_section == 2? 2 : 0),
                    color:(active_section == 2? '#714DD9' : '#565659')
                }}
            >
            Tasks
            </Text>
            <Text 
                className='text-md font-medium text-[#565659]' 
                style={{
                    borderBottomColor:(active_section == 3?'#714DD9':'#eee'),
                    borderBottomWidth:(active_section == 3? 2 : 0),
                    color:(active_section == 3? '#714DD9' : '#565659')
                }}
            >
            Team
            </Text>
...
const Attachments_Section=()=>{
    return(
        <View className='space-y-2 w-full'>
            <View className='space-y-2'>
                <Text className='text-md font-medium text-[#565659]'>Attachments</Text>
                ...
                <View className='flex-row space-x-2'>
                    <Feather name="file" size={16} color="black" />
                    <Text>Contract</Text>
                </View>
            </View>
        </View>
...
const Tasks_Section=()=>{
    return(
        <View className='space-y-2 w-full h-full' style={{Zindex:1}}>
            <View className='flex-row items-center justify-between'>
                <Text className='text-xl font-medium text-[#565659]'>Tasks</Text>
                <Text className='text-md text-white rounded-md p-2 bg-secondary-color-1'>Add task</Text>
            </View>
            {/**task data starts here */}
            <ScrollView
                className=' space-y-2 w-full h-full pb-2'
